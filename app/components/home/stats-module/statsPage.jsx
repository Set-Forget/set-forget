...
const StatsPage = () => {
  return (
    <div className=" bg-sf-black">
      <div className="bg-sf-white rounded-t-[80px] text-sf-dblue">
        <Container className={"py-16 grid lg:grid-cols-12 gap-5 px-5 lg:px-20"}>
          <div className="col-span-12 flex justify-between items-center">
            <div className="relative">
            <Image src={sparkle} alt="" className="absolute bottom-20 lg:-top-10 -right-10 lg:-left-10"/>
              <h1 className="text-5xl lg:text-heading leading-none reg-neue">Why</h1>
              <h1 className="text-5xl lg:text-heading leading-none bold-neue">
  ...
  <div className="relative col-span-12 lg:col-span-4 h-[405px] flex flex-col p-8 rounded-3.5xl">
